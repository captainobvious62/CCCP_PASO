classdef ncedcFetch
   ...
   %  the online manual http://www.ncedc.org/dms/nodes/dmc/software/downloads/irisFetch.m/.
   %
 ...
 ******************************************************************************
   ...
   methods(Static)
      ...
      function ts = Traces(network, station, location, channel, startDate, endDate, varargin )
         ...
         %  These are the same poles/zeros as found from http://service.ncedc.org/irisws/sacpz/1/
         %
         ...
         %     Sample:
         %       unamepwd = {'nobody@ncedc.org', 'anonymous'}
         %
         ...
         %  example, the IRIS datacenter would be 'http://service.ncedc.org/'. These
               ...
               switch class(param)
                  case 'cell'
                     assert(numel(param)==2 && all(cellfun(@ischar, param)),...
                        'A cell parameter is assumed to contain credentials. eg. {''nobody@ncedc.org'',''anonymous''}.');
      ...
      function [channelStructure, urlParams] = Channels(detailLevel, varargin)
         ...
         %  to query. By default queries go to: http://service.ncedc.org/fdsnws/station/1/
         %
      ...
      function [networkStructure, urlParams] = Networks(detailLevel, network, station, location, channel, varargin)
         ...
         %     http://service.ncedc.org/fdsnws/station/1/
         %
      ...
      function [events, urlParams] = Events(varargin)
         ...
         %  to query. By default queries go to: http://service.ncedc.org/fdsnws/event/1/
         %
         ...
         %
         %  http://service.ncedc.org/fdsnws/event/1/
         %
         %  Examples:
         %
      ...
      function connectToJar(isSilent)
         ...
         %  available from:
         %
         %  http://www.ncedc.org/files/IRIS-WS/2/
         %
      ...
      function [respstructures, urlparams] = Resp(network, station, location, channel, starttime, endtime)
         ...
         serviceManager = edu.iris.dmc.service.ServiceUtil.getInstance();
         baseUrl = 'http://service.ncedc.org/ncedcws/resp/1/';
         serviceManager.setAppName(['MATLAB:irisFetch/' irisFetch.version()]);
      ...
      function runExamples()
         ...
         codeToExecute={
            ...
            'n = irisFetch.Networks(''Response'',''IU'',''ANMO'','''',''BHZ'',''baseurl'',''http://service.ncedc.org/fdsnws/station/1/'')';
      ...
      function [js, je] = testResp(starttime, endtime)
         ...
         function testThis(varargin)
            try
               ...
               [s,code]=urlread('http://service.ncedc.org/ncedcws/resp/1/query','get', parampairs); %#ok<NASGU>
