function arrival_times = produceArrivalTimes(NET,CHA_Z,CHA_N,CHA_E,STA,first_date,last_date,pWaveArrival,sWaveArrival,window,template)
...
final_correlation_savename = sprintf('./CO/%s/Correlation_%s_%s_%s_%s_%s.mat',template,template,datestr(first_date),datestr(last_date),STA,CHA_Z);
...
final_correlation_savename = sprintf('./CO/%s/Correlation_%s_%s_%s_%s_%s.mat',template,template,datestr(first_date),datestr(last_date),STA,CHA_N);
save(final_correlation_savename,'BHN');
...
final_correlation_savename = sprintf('./CO/%s/Correlation_%s_%s_%s_%s_%s.mat',template,template,datestr(first_date),datestr(last_date),STA,CHA_E);
save(final_correlation_savename,'BHE');
